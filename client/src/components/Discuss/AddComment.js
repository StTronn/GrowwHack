    ...
    <>
      ...
      <div className=" w-full grid justify-items-end my-2 inline-flex rounded shadow">
        <span
          ...
          className="cursor-pointer inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-semibold rounded text-sp-green bg-white hover:bg-indigo-50"
        >
